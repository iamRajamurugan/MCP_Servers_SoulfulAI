...
${resultsText}`,
  ...
  server.tool(
    "get-library-docs",
    `Fetches comprehensive, up-to-date documentation content for a specified Context7-compatible library.

  This tool is crucial for retrieving the actual text and code examples from a library's documentation. Once the documentation is fetched, you are expected to:
  1. Carefully read and understand the retrieved content.
  2. Synthesize the information relevant to the user's query.
  3. Formulate a concise and informative answer or summary based directly on the documentation.
  4. DO NOT just return the raw documentation unless explicitly requested by the user. Always summarize or answer specific questions.
