...
async function main() {
    ...
    try {
        const selfhostedClient = await SelfhostedSupabaseClient.create({
            supabaseUrl: 'https://xhurfcbdcybcxauggkdq.supabase.co',
            supabaseAnonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhodXJmY2JkY3liY3hhdWdna2RxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTIxMjE2MzksImV4cCI6MjA2NzY5NzYzOX0.Id4Mvq9Z8m9dZHvbuurXQ8yLGGyMksr4tEQoryelNBQ',
            supabaseServiceRoleKey:'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhodXJmY2JkY3liY3hhdWdna2RxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MjEyMTYzOSwiZXhwIjoyMDY3Njk3NjM5fQ.vdkG4Ln79tKfEqjRY6HRA61_q9GWsqFfg0KoFf1vABE',
            databaseUrl:'postgresql://postgres:sudhesh1290@db.xhurfcbdcybcxauggkdq.supabase.co:5432/postgres',
            jwtSecret: 'i7AWGTOih+AQSi31cdBJ2vV5smzB11EkrwuNyGXpY0u+TQ/lXGaDXAJhOm/9eNLRgDzbsKEZweKdT5O6jolpFw==',
        });
