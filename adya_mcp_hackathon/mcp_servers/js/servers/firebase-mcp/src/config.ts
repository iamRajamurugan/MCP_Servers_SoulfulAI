...
export function getConfig(): ServerConfig {
  ...
  let transportStr = TransportType.STDIO;
  ...
  const config: ServerConfig = {
    ...
    serviceAccountKeyPath: "S:/MCP/adya_mcp_hackathon/mcp_servers/js/servers/firebase-mcp/src/service-account-key.json",
    storageBucket: "mcp-demo-b758a.appspot.com",
    transport,
    http: {
