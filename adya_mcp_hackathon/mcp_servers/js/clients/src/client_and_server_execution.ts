...
export async function ClientAndServerExecution(payload:any, streaming_callback:any) {
    try{
        ...
        console.log("DETAILS:",client_details)
        console.log("CREDENTIALS:",selected_server_credentials)
        console.log("CLIENT:",selected_client)
        console.log("SERVER:",selected_server)
...
async function CallAndExecuteTool(selected_server:any, server_credentials:any,tool_name:any, args:any) {
    ...
    switch (selected_server) {
        ...
        case "G_DRIVE":
            ...
            case "SALESFORCEMCP":
    args["__credentials__"] = {
        "username": server_credentials[selected_server]?.username || "",
        "password": server_credentials[selected_server]?.password || "",
        ...
        "instanceUrl": server_credentials[selected_server]?.instanceUrl || ""
    };
    break;
    case "context7":
        args["__credentials__"]={
        ...
        case "firebase-mcp":
            args["__credentials__"]={
            "access-token": server_credentials[selected_server]?.access_token || "",
        };  
        case "selfhosted-supabase-mcp":
            args["__credentials__"]={
            "access-token": server_credentials[selected_server]?.access_token || "",
        };  
        case "SLACK":
